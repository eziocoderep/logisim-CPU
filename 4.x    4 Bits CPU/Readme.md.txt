...
(There are 16 bits of Ram build in Nand but that whole ram in nand would be just too heavy)

The instruction set is very limited and the whole thing rather slow.
It comes with 2 test progamm written in the cps asm:
...
in the top left of the circuit press the on "ON" light green button

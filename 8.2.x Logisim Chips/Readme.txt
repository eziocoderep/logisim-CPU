...
In the top left of the circuit click the "loader 256" button ot the 4k version
...
- DMA a direct memory access to connect a HD to the next cpu I'm plannning the 8.4.x
- MMU a memory management unit to implement virtual memory and in theory processes
  It's a bit of a dead end, the hardware for VM works fine but this mahcine address space
